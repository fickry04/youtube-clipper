      ...
      {showDialog && (
        ...
        >
          <div className="delete-dialog">
            ...
            <h2 id="delete-project-dialog-title" className="delete-dialog-title">
              Delete Project?
            </h2>
            ...
            {videoCount > 0 && (
              <div className="delete-dialog-warning">
                ...
                <strong>{videoCount} video{videoCount !== 1 ? 's' : ''}</strong> and all
                their clips, transcripts, and associated files.
              </div>
            )}
